...
call_user_func(
	function($extKey)
	{
        ...
        // Cache
        //=================================================================
        $GLOBALS['TYPO3_CONF_VARS']['SYS']['caching']['cacheConfigurations']['gadgetogoogle_filteroptions'] ??= [];
        $GLOBALS['TYPO3_CONF_VARS']['SYS']['caching']['cacheConfigurations']['gadgetogoogle_navigationobjects'] ??= [];
        ...
        // $GLOBALS['TYPO3_CONF_VARS']['FE']['cacheHash']['excludedParameters'][] = 'gadgetogoogle_detail[location]'; // needed for canonical URL
        ...
        // $GLOBALS['TYPO3_CONF_VARS']['FE']['cacheHash']['excludedParameters'][] = 'tx_gadgetogoogle_detail[location]'; // needed for canonical URL
