 ...
 * ========================
 * <script type="module">
 *      import Madj2kGoogleMaps from "path/to/this/script.mjs";
 *      let Map = new Madj2kGoogleMaps(configuration);
 * </script>
 *
 */
export default class Madj2kGoogleMaps {

  #settings = {
    apiKey: '',
    filterButtonClass: 'map-filter-button',
    consentButtonClass: 'map-consent-button',
    mapContainerId: '#madj2k-google-map',
    cookieName: 'consent-google-map',
    mapConfig: {
      zoom: 12,
      mapTypeControl: false,
